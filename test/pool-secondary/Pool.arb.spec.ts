...
describe('PoolArb', function () {
  ...
  describe('Asset USDT (6 decimals) and USDC (6 decimals)', function () {
    beforeEach(async function () {
      ...
      await fundUserAndApprovePool(this.USDT, owner, usdc('100000').toString(), this.pool, owner)
      await fundUserAndApprovePool(this.USDC, owner, usdc('100000').toString(), this.pool, owner)
